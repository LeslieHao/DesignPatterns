...
// * cglib 源码
// * @author HaoHao
// * @date 2018/12/14下午6:35
// */
//public class EnhancerSource extends AbstractClassGenerator {
...
//    };
//
//    private static final AbstractClassGenerator.Source SOURCE = new Source(Enhancer.class.getName());
...
//            throw new CodeGenerationException(e);
//        }
//        return new WeakReference<Enhancer.EnhancerFactoryData>(factoryData);
//    }
//
//    @Override
